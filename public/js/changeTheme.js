...
if (getCookie("theme") === "white") {
  document.getElementById("themeDiv").innerHTML =
    '<link href="../css/white.css" rel="stylesheet" id="theme"/>';
} else {
  document.getElementById("themeDiv").innerHTML =
    '<link href="../css/black.css" rel="stylesheet" id="theme"/>';
}

async function changeTheme() {
  var t = document.getElementById("theme").href;
  let theme;
  if (t === `https://my-dash.tk/css/white.css`) {
    theme = "white";
  } else {
    theme = "black";
  }
